...
const AdminPage = () => {
    ...
    const Forms = [
        <form className='formWrapper'>
            ...
            <button type='button' className='subBtn' onClick={(e)=>{
                ...
                Axios.post("http://20.219.215.210:1000/Admin/AddFaculty",req).then(res=>{
        ...
        <button type='button' className='subBtn' onClick={(e)=>{
            ...
            Axios.post("http://20.219.215.210:1000/Admin/AddStudent",req).then(res=>{
    ...
    <button type='button' className='subBtn' onClick={(e)=>{
        ...
        Axios.post("http://20.219.215.210:1000/Admin/AddBatches",req).then(res=>{
...
<button type='button' className='subBtn' onClick={(e)=>{
    ...
    Axios.post("http://20.219.215.210:1000/Admin/Batches/AddCourse",req).then(res=>{
...
<button type='button' className='subBtn' onClick={(e)=>{
    ...
    Axios.post("http://20.219.215.210:1000/Admin/Faculty/AddCourse",req).then(res=>{
        window.alert("Course Added")
        inps.forEach(el=>{
            el.value=""
        })
